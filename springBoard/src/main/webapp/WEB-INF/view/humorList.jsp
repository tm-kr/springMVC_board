				...
				<div class="search shadow-sm">
					...
					<div>
						<div class="search-cate" style="float: left"><a style ="color: #98a0a7" href="${pageContext.request.contextPath}/humor/1">최신순</a>  
																	<a style ="color: #98a0a7" href="${pageContext.request.contextPath}/humorPopular/1">조회순</a></div>  
				...
				<div class="list shadow-sm">
					...
					<nav aria-label="Page navigation example">
					  <ul class="pagination mt-3" >
					    <li class="page-item">
					      <a class="page-link" href="${pageContext.request.contextPath}/humoe/${page.startPage + 2 - page.countPage}" aria-label="Previous">
					        <span aria-hidden="true">&laquo;</span>
					      </a>
					    </li>
					    
					    <c:forEach var="i"  begin="${page.startPage }" end="${page.endPage }">
					    	<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/humor/${i}">${i}</a></li>
					    </c:forEach>
					    
					    <c:if test="${page.block > page.endPage}">
					    <li class="page-item">
					      <a class="page-link" href="${pageContext.request.contextPath}/humor/${page.startPage + page.countPage}" aria-label="Next">
